...
do {
    ...
    if (isNaN(cantidadVendedores) || cantidadVendedores <= 0) {
        alert('Por favor, ingrese una cantidad válida de vendedores.');
    }
...
for (let i = 1; i <= cantidadVendedores; i++) {
    ...
    montoVentas = parseFloat(prompt('Ingrese el monto de ventas: '));
    ...
    switch (true) {
        ...
        case (montoVentas > 0 && montoVentas < 75000):
            porcentajeComision = 5; //5% 0-75000
            break;
        case (montoVentas >= 90000 && montoVentas < 200000):
            porcentajeComision = 7; //7% 90000-200000
            break;
        case (montoVentas >= 300000 && montoVentas < 1000000):
            porcentajeComision = 8; //8% 300000-1000000
            break;
        case (montoVentas >= 1500000):
            porcentajeComision = 10; //10% >=1500000
            break;
        default:
            porcentajeComision = 6; //6% cualquier otro monto fuera de rango (1000001-1499999)
            break;
    }
    //fin del switch
    ...
    alert("El ingreso del vendedor " + i + ", esta basado en su: sueldo base: " + sueldoBase + ", monto de sus ventas: " + montoVentas + ", el porcentaje de comision por ventas: " + porcentajeComision + "%, bono por adulto mayor: " + bonoAdultoMayor + " y su ingreso total es: " + ingreso);
}
